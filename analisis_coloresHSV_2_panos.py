# ============================================================
#  analisis_coloresHSV_2_panos.py
#  Segmentación de blobs de color (HSV) sobre imágenes panoramicas
...
#  Ejecuta:   python analisis_colores_hsv.py o py .....
# ============================================================
...
# ----------------------------- CONFIG -----------------------------
CONFIG = {
    # Carpeta con imágenes panos (por ejemplo, *_und.png de tu pipeline)
    "UNDIST_DIR": r"C:\Users\GMADRO04\Documents\SOLER\QUPA\Testeo_QUPA\camara_QUPA\panos",

    # Carpeta de salida para overlays y máscaras
    "OUT_DIR": r"C:\Users\GMADRO04\Documents\SOLER\QUPA\Testeo_QUPA\camara_QUPA\seg_color_panos",
